...
PLL12M PLL12MHz(RESET, CLOCK50M, MCLK, PLLlocked[0]);
...
Sophie2Osc( CLOCK50M, //system 50mhz clk
	...
	message[9:0], //from arduino, for the variable clock length
	1'b1, //for the mem reg containing user input, stops user from chagning all parameters
...
JacobTopLevel Oscillators( CLOCK48kHz, RESET, 2'b00, message[3:0],
	memfrequency0,
	memfrequency1,
	memfrequency2,
	memfrequency3,
...
ADSRClockDiv ADSR_CLOCKDIV(
	...
	10'd000,
	10'd1000, 
	1'b1, //ENABLE = user switch - load to DFF
...
JaneTopLevel ADSR_TL( CLOCK12MHz, CLOCK48kHz, CLOCK48kHz, CLOCK48kHz, CLOCK_RELEASE, RESET, Triggeradsr,
	wave0,
	wave1,
	wave2,
	wave3,
